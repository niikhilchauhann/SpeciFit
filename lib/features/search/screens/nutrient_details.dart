...
import '/features/search/screens/widgets/nutrient_widget.dart';
...
class _NutrientDetailsState extends State<NutrientDetails> {
  final ValueNotifier<List<bool>> _isOpen = ValueNotifier([false, false]);
                    ...
                    children: [
                      ...
                      Text(
                        widget.servingDescription1 == ''
                            ? '${widget.servingDescription1} ${widget.servingWeight1} g'
                            : '${widget.servingDescription1}, ${widget.servingWeight1} g',
                      ...
                      NutrientWidgetSmall(
                        name: "Dietary Fiber",
                        value: widget.fiber + " g",
                      ),
                      NutrientWidgetSmall(
                        name: "Sugars",
                        value: widget.sugars + " g",
                      ),
                      NutrientWidget(
                        name: "Protein",
                      ...
                      ValueListenableBuilder<List<bool>>(
                        ...
                        builder: (context, isOpenList, child) {
                          return ExpansionPanelList(
                            elevation: 0,
                            expansionCallback: (i, isOpen) {
                              final newList = List<bool>.from(isOpenList);
                              newList[i] = !isOpenList[i];
                              _isOpen.value = newList;
                            },
                            children: [
                              ExpansionPanel(
                                canTapOnHeader: true,
