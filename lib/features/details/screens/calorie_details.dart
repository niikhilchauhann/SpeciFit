    ...
    return ValueListenableBuilder(
      ...
      builder: (context, _, __) {
        return Scaffold(
          appBar: AppBar(
            centerTitle: true,
            title: Text("Calories Details", style: theme.titleMedium),
            actions: [
              Padding(
          ...
          body: ListView(
            ...
            children: [
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: AppColors.instance.caloriesColor.withValues(
                          alpha: 0.1,
                        ),
                    ...
                    CircularPercentIndicator(
                      ...
                      progressColor: AppColors.instance.caloriesColor
                          .withValues(alpha: 0.5),
                      backgroundColor: AppColors.instance.caloriesColor
                        ...
                        child: Column(
                          ...
                          children: [
                            Icon(
                              ...
                              size: 30,
                              color: AppColors.instance.caloriesColor,
                            ),
                            Text(
                              _totalCalories.toStringAsFixed(0),
                              style: theme.headlineSmall,
                            ),
                            Text("Calories", style: theme.labelLarge),
                          ],
                        ),
                      ),
                    ),
              ...
              Text("Macros Today", style: AppTextStyles.instance.titleLarge),
              Padding(
...
class MacroProgress extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(macroname, style: Theme.of(context).textTheme.titleMedium),
        const SizedBox(height: 10),
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
        ...
        ClipRRect(
          ...
          child: LinearProgressIndicator(
            ...
            minHeight: 5,
            color: macrocolor,
            backgroundColor: macrocolor.withValues(alpha: 0.2),
          ),
        ),
      ],
    );
