...
import '/features/workouts/screens/exercise_title.dart';
import '/features/workouts/screens/workout_tiles.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Woman", style: Theme.of(context).textTheme.titleMedium),
        elevation: 0,
      ),
      body: ListView(
        children: [
          ...
          Padding(
            ...
            child: Text(
              "These workouts will help you get:",
