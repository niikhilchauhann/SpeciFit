...
import '/features/workouts/screens/exercise_card.dart';
import '/features/workouts/screens/workout_details.dart';

class WorkoutTiles extends StatelessWidget {
  final List list;
  const WorkoutTiles({super.key, required this.list});
