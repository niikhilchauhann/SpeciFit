...
class _ChatPageState extends ConsumerState<ChatPage> {
    ...
    if (selectedImage != null) {
      content.add(
        Content.multi([
          ...
          DataPart('image/jpeg', selectedImage),
        ]),
      );
    } else {
  ...
  Future<void> _speakResponse(String input) async {
    try {
      ...
      debugPrint('Error in speech response: $e');
    }
  }
    ...
    return ValueListenableBuilder(
      ...
      builder: (context, _, __) {
        return Scaffold(
          ...
          appBar: AppBar(title: Text('Chat with SpeciFit AI')),
          body: SafeArea(
            child: Column(
              children: [
                Padding(
                ...
                Expanded(
                  child: chat_ui.Chat(
                    ...
                    onAttachmentPressed: widget.imageSearch
